...
public class UserRecommendedController {
    ...
    public UserRecommendedController(EventRepository eventRepository, UserRepository userRepository, FavouriteRepository favouriteRepository, SharedPrefManager sharedPrefManager) {
    ...
    public List<EventSummary> performSearch(String filterBy, boolean isAscending, String query) {
        ...
        ascendingList = eventRepository.searchRecommendedEventSummariesForUser(filterBy, true, cleanQuery, user);
        descendingList = eventRepository.searchRecommendedEventSummariesForUser(filterBy, false, cleanQuery, user);
